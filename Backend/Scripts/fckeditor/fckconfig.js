...
FCKConfig.ToolbarSets["Default"] = [
    ['OnlineVideo', 'Insert_Variables', 'LangSwitcher', 'mycombo','ajaxAutoSave', 'FormulaEditor', 'googlemaps', 'MaximizeInDialog', 'ajaxPost'],
    '/',
	['addbuttondemo', 'Source', 'DocProps', '-', 'Save', 'NewPage', 'Preview', '-', 'Templates'],
